...
public class Lava : MonoBehaviour
{
    ...
    public Lava m_parent = null;
    public List<Lava> m_children = new List<Lava>();
    ...
    private void SpawnAdjacentCell()
    {
        ...
        //if (data != null)
        //{
        //    LevelManager.Instance.DelayedOverrideCell(m_data.m_sectionIndex, LevelManager.Instance.m_lavaPrefab, data.Coords);
        //    LevelManager.Instance.AddChainData(this, data.Coords);
    ...
    public void AddChild(Lava _child)
    {
